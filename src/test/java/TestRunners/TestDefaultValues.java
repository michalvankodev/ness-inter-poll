...
public class TestDefaultValues {
    ...
    public static final String DEFAULT_LINK = "http://localhost:3000/";
    ...
    public static void setOperatingSystem(String operatingSystem) {TestDefaultValues.operatingSystem = operatingSystem;}
